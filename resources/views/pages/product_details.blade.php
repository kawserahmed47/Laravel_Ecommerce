<!--
<p>{{$showDBproduct->product_name}} </p>
<p>{{$showDBproduct->product_short_desc}} </p>
<p>{{$showDBproduct->product_long_desc}} </p>
<p>{{$showDBproduct->product_price}} </p>

<img src="{{URL::to($showDBproduct->product_image)}}" style="height: 200px" alt="" />
...
<div class="view-product">
	<img src="{{URL::to($showDBproduct->product_image)}}" alt="" />
	<h3>ZOOM</h3>
</div>
...
<h2>{{$showDBproduct->product_name}}</h2>
<p>Web ID: 1089772</p>
<img src="{{asset('frontend/images/product-details/rating.png')}}" alt="" />
<span>
<span>{{$showDBproduct->product_price}} BDT</span>
...
<input name="product_id" type="hidden" value="{{$showDBproduct->product_id}}" />
...
<p><b>Size:</b>{{$showDBproduct->product_size}}</p>
<p><b>Color:</b>{{$showDBproduct->product_color}}</p>
<p><b>Brand:</b>{{$showDBproduct->manufacture_name}} </p>

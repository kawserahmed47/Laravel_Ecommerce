                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        ?>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{URL::to('/productByCategory/'.$v_category->category_id)}}">{{$v_category->category_name}}</a></h4>
                                </div>
                            </div> 
                        ...
                        ?>
                                    ...
                                    <li><a href="{{URL::to('/productByManufacture/'.$v_manufacture->manufacture_id)}}"> <span class="pull-right">(50)</span>{{$v_manufacture->manufacture_name}}</a></li>
                                    <?php
                             }
                              ?>
                                </ul>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    ...
                    <p class="pull-right">Designed by <span><a target="_blank" href="http://kawser.xyz">Kawser Ahmed</a></span></p>
                </div>
            </div>
        </div>

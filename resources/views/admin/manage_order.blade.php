...
@section('admin_content')
			...
			<ul class="breadcrumb">
				...
				<li><a href="{{URL::to('/')}}">Manage Order</a></li>
			</ul>
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">{{$v_order->order_total}}</td>
                                                                        ...
                                                                        <td>
                                                                            <a class="btn btn-success"  href="{{URL::to('/success-order/'.$v_order->order_id)}}">
										<i class="halflings-icon white thumbs-up"></i> 
									</a>
                                                                                
                                                                             <a class="btn btn-info" href="{{URL::to('/view-order/'.$v_order->order_id)}}">
										<i class="halflings-icon white view-product"></i> 
									</a>
                                                                                
                                                                            <a class="btn btn-danger" onclick="return confirm('Are you sure?')" href="{{URL::to('/delete-order/'.$v_order->order_id)}}">

...
@section('admin_content')
			...
			<ul class="breadcrumb">
				...
				<li><a href="{{URL::to('/addproduct')}}">All product</a></li>
			</ul>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
                                                                    @if($v_product->publication_status==1)
									<a class="btn btn-dark" href="{{URL::to('/inactivePublication2/'.$v_product->product_id)}}">
										<i class="halflings-icon white thumbs-down"></i>  
									</a>
                                                                    @else
                                                                    
                                                                    <a class="btn btn-success" href="{{URL::to('/activePublication2/'.$v_product->product_id)}}">
									...
									<a class="btn btn-danger" onclick="return confirm('Are you sure?')" href="{{URL::to('/deleteproduct/'.$v_product->product_id)}}">

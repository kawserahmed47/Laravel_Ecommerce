...
<ul class="breadcrumb">
				...
				<li><a href="{{URL::to('/edit_product')}}">Update product</a></li>
			</ul>
				...
				<div class="box span12">
					...
					<div class="box-content">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
                                                              <input type="text" name="product_name"  value="{{$product_info->product_name}}" required="">
							  </div>
							</div>
                        ...
                        ?>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
                                                              <textarea class="cleditor" name="product_short_desc" rows="3" required="" >
							  ...
							  <div class="controls">
                                                              <textarea class="cleditor" name="product_long_desc" rows="3" required="" >
                                                                   {{$product_info->product_long_desc}}
                                                              </textarea>
							  </div>
							</div>
							  ...
							  <div class="controls">
                                                              <input type="text" name="product_price"  value=" {{$product_info->product_price}}" required="">
							  </div>
							</div>
							  ...
							  <label class="control-label" >Product Image</label>
                                                          <img src="{{$product_info->product_image}}" style="height:80px; width: 80px">
							  <div class="controls">
							  ...
							  <div class="controls">
                                                              <input type="text" name="product_size"  value=" {{$product_info->product_size}}" required="">
							  </div>
							</div>
							  ...
							  <div class="controls">
                                                              <input type="text" name="product_color"  value=" {{$product_info->product_color}}" required="">
							  </div>
							</div>

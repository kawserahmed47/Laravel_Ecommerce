...
class CartController extends Controller
{
    ...
    public function show_cart(){
       ...
       $all_published_category = DB::table('tbl_category')->where('publication_status',1)->get();
        ...
        $manage_publish_category = view('pages.add_to_cart')->with('all_published_category',$all_published_category);
       return view('welcome')->with('pages.add_to_cart',$manage_publish_category);
    }
